...
public class Registrazione extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try(InputStream contenutoFile = file.getInputStream()){
            ...
            File fileDaSalvare = new File("/Users/ricca/Documents/NetBeansProjects/ProgettoFPW/web/uploads/" + file.getSubmittedFileName());  //modificare questo percorso in  funzione della macchina virtuale
